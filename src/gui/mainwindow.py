...
from docktemplate import DockTemplate
from dockplot import DockPlot
from dockvariable import DockVariable
from variable import VariableProperties
from plot import PlotProperties
from dockcalculator import DockCalculator
